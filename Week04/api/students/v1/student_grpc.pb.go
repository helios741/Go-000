...
type StudentClient interface {
	GetById(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentReply, error)
}
...
func (c *studentClient) GetById(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentReply, error) {
	out := new(StudentReply)
	err := c.cc.Invoke(ctx, "/Student/getById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StudentServer interface {
	GetById(context.Context, *StudentRequest) (*StudentReply, error)
...
func (UnimplementedStudentServer) GetById(context.Context, *StudentRequest) (*StudentReply, error) {
...
func _Student_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudentServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Student/getById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServer).GetById(ctx, req.(*StudentRequest))
	}
...
var _Student_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getById",
			Handler:    _Student_GetById_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "v1/student.proto",
}
